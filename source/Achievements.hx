...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Hidden achievement
		...
		["Creepy Mouse",				"Beat Really-Happy in Freeplay.",							false],
		["Huggy Wuggy",					"Beat Playtime in Freeplay.",								false],
		["Creepy Huggy",				"Beat Really-Happy-Playtime in Freeplay.",					false]
	];
